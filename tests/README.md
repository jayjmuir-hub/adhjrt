...
fault has to be caught by name — **555 of them as of 5 Aug 2026**, and the number
...
| `_prove-registration.js` | the fault injection. Not a test; a check on the tests. 555 faults, all caught by the named check, 30 suites clean undamaged |

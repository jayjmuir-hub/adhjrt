...
fault has to be caught by name — **630 of them as of 6 Aug 2026**, and the number
...
| `_prove-registration.js` | the fault injection. Not a test; a check on the tests. 630 faults, all caught by the named check, 31 suites clean undamaged |
